                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold" id="initiate"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle text-center">
                                        ...
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold " id="success"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle text-center">
                                        ...
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold" id="failed"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle text-center">
                                        ...
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold" id="error"></span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
