        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-profile">
                    <img src="{{ env('APP_URL') }}/assets/img/bg-profile.jpg" alt="Image placeholder"
                        class="card-img-top">
                    <div class="row justify-content-center">
                        <div class="col-4 col-lg-4 order-lg-2">
                            <div class="mt-n4 mt-lg-n6 mb-4 mb-lg-0">
                                <a href="javascript:;">
                                    <img src="{{ env('APP_URL') }}/assets/img/team-2.jpg"
                  ...
                  <div class="col">
                    ...
                    <div class="text-center mt-4">
                        ...
                        <div class="h6 font-weight-300">
                            <i class="ni location_pin mr-2"></i>Tamilnadu, India
                        </div>
                        {{-- <div class="h6 mt-4">
