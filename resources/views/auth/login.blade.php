          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
                ...
                <div class="text-center">
                  <button type="submit" name="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Login</button>
                </div>
                <div class="form-footer">
                    {{-- <button type="submit" class="btn btn-dark">
                        Login
                ...
                <p class="text-sm mt-3 mb-0">Don't have an account? <a href="{{ route('register') }}" class="text-dark font-weight-bolder">Sign Up</a></p>
              </form>
            </div>
          </div>
        </div>
