...
<body>
    ...
    <section id="product1" class="section-p1" class="fade-up">
        ...
        <div class="pro-container">
            ...
            @foreach ($orders as $order)
                <div class="pro fade-up" onclick="window.location.href ='shopproduct.html'">
                    @if ($order->image)
            ...
            <div class="pro fade-up" onclick="window.location.href ='shopproduct.html'">
                <img src="{{ env('APP_URL') }}/assets/Images/Products/f2.jpg" alt="" />
                <div class="des">
                    <span>Zara</span>
                    <h5>Printed Aesthetics Shirts</h5>
                    <div class="star">
                ...
                <a href="" class="cart"><i class="fa-solid fa-cart-shopping"
                        style="margin-right: 10px;"></i>Buynow</a>
            </div>
            <div class="pro fade-up" onclick="window.location.href ='shopproduct.html'">
                <img src="{{ env('APP_URL') }}/assets/Images/Products/f3.jpg" alt="" />
                <div class="des">
                    <span>Zara</span>
                    <h5>Printed Aesthetics Shirts</h5>
                    <div class="star">
            ...
            <div class="pro fade-up" onclick="window.location.href ='shopproduct.html'">
                <img src="{{ env('APP_URL') }}/assets/Images/Products/f4.jpg" alt="" />
                <div class="des">
                    <span>Zara</span>
                    <h5>Printed Aesthetics Shirts</h5>
                    <div class="star">
            ...
            <div class="pro fade-up">
                <img src="{{ env('APP_URL') }}/assets/Images/Products/f5.jpg" alt="" />
                <div class="des">
                    <span>Zara</span>
                    <h5>Floral Pattern Shirts</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="pro fade-up">
                <img src="{{ env('APP_URL') }}/assets/Images/Products/f6.jpg" alt="" />
                <div class="des">
                    <span>Levis</span>
                    <h5>Casual Shirts</h5>
                    <div class="star">
            ...
            <div class="pro fade-up">
                <img src="{{ env('APP_URL') }}/assets/Images/Products/f7.jpg" alt="" />
                <div class="des">
                    <span>Zara</span>
                    <h5>Casual Jeans</h5>
                    <div class="star">
            ...
            <div class="pro fade-up">
                <img src="{{ env('APP_URL') }}/assets/Images/Products/f8.jpg" alt="" />
                <div class="des">
                    <span>Zara</span>
    ...
    <section id="banner" class="section-m1 " style="background-image: url('../assets/Images/banner/b2.jpg')";>
        <h4 class="fade-up">Repair Services</h4>
        <h2 class="fade-up">Up to <span>70% off </span> - All t-Shirts &amp; Accessories</h2>
        <button class="normal fade-up">Explore More</button>
    </section>
