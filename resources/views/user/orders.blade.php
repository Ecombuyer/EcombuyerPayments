                    ...
                    <div class="card-body">
                        {{-- <h3 class="card-title">Create Payment Link</h3>     --}}
                              ...
                              {{-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> --}}
                                    <div class="mb-3">
                                      <h4>Product Name</h4>
                                      <input type="text" class="form-control" placeholder="Short Sleeve T-Shirt" name="product_name" style="border-radius: 10px">
                                    </div>
                                    <div class="mb-1">
                                        <h4>Product Description</h4>
                                        <textarea id="tinymce-mytextarea" name="product_description" style="border-radius: 10px" >buhbvu</textarea>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="input-group mb-3">
                              <div class="input-group-prepend">
                                <div class="input-group-text"><i class="fa-solid fa-indian-rupee-sign my-1"></i></div>
                              </div>
                              <input type="text" name="product_price" class="form-control" id="phpename" placeholder="0.00" required autocomplete="off" style="border-radius: 0px 10px 10px 0px">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="text" class="form-control" id="phpename" placeholder="0.00" required autocomplete="off" style="border-radius: 0px 10px 10px 0px">
                            </div>
                        </div>
                    </div>
                    <div class="row">
