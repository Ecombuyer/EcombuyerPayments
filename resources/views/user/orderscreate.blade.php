        ...
        <div class="col-md-8 mt-4">
          <div class="card" style="border-radius:30px">
            <div class="card-header pb-0 px-3">
              <h4 class="mb-3"><span  style="color: #0054A6;"> ORDER </span> PRODUCTS </h4>
            </div>
        ...
        <div class="col-lg-8">
            <div class="card" style="border-radius: 30px">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <label for="name" class="form-label" style="font-size: 13px; font-weight: 600;">Price</label>
                            <div class="form-group">
                              <div class="input-group">
                                  <span class="input-group-text" id=""><i class="fa-solid fa-indian-rupee-sign my-1"></i></span>
                                  <input type="number" class="form-control" name ="product_price" placeholder="0.00" aria-label="Username" aria-describedby="basic-addon1">
                              </div>
                          </div>
                        </div>
                        <div class="col-lg-6">
                            <label for="name" class="form-label"  style="font-size: 13px; font-weight: 600;">Comapare-at Price</label>
                            <div class="form-group">
                              <div class="input-group">
                                  <span class="input-group-text" id=""><i class="fa-solid fa-indian-rupee-sign my-1"></i></span>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <label for="name" class="form-label"  style="font-size: 13px; font-weight: 600;">Cost Per Item</label>
                            <div class="form-group">
                              <div class="input-group">
                                  <span class="input-group-text" id=""><i class="fa-solid fa-indian-rupee-sign my-1"></i></span>
                                  <input type="number" class="form-control" placeholder="0.00" aria-label="Username" aria-describedby="basic-addon1">
                        ...
                        <div class="col-lg-4">
                            <label for="name" class="form-label"  style="font-size: 13px; font-weight: 600;">Profit</label>
                            <div class="form-group">
                              <div class="input-group">
                                  <span class="input-group-text" id=""><i class="fa-solid fa-indian-rupee-sign my-1"></i></span>
                                  <input type="number" class="form-control" placeholder="0.00" aria-label="Username" aria-describedby="basic-addon1">
                        ...
                        <div class="col-lg-4">
                            <label for="name" class="form-label"  style="font-size: 13px; font-weight: 600;">Margin</label>
                            <div class="form-group">
                              <div class="input-group">
                                  <span class="input-group-text" id=""><i class="fa-solid fa-indian-rupee-sign my-1"></i></span>
                                  <input type="number" class="form-control" placeholder="0.00" aria-label="Username" aria-describedby="basic-addon1">
