...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ env('APP_URL') }}/assets/img/apple-icon.png" />
...
<body>
    ...
    <div class="image-container"
        style="background:linear-gradient(to right, rgba(110, 110, 189, 0.938),rgba(73, 73, 179, 0.938),rgba(60, 62, 184, 0.938));">
            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1">
                    ...
                    <div class="wizard-container">
                        <div class="card wizard-card" data-color="blue" id="wizardProfile" style="border-radius: 30px">
                            ...
                            <form action="{{ route('orders.placeorder') }}" method="POST">
                                ...
                                <div class="wizard-header"
                                    ...
                                    <h3 style="font-weight: bold;" class="heading"><img src="assets/img/Layer 1 (5).png"
                                            alt="ecom" width="25px" style="margin: 7px 10px;">Ecom Buyer</h3>
                                    <h6 style="font-weight: 500;"><i class="fa-solid fa-lock"
                                            style="font-size: medium;padding: 0px 5px;"></i>Checkout</h6>
                                </div>
                                <div class="wizard-navigation">
                                    <ul>
                                        <li><a href="#about" data-toggle="tab">Summary</a></li>
                                        <li>
                                            <a href="#account" data-toggle="tab"> Address</a>
                                        </li>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input name="mobileno" id="mobileno"
                                                            oninput="validateFirstDigit()" maxlength="10"
                                        ...
                                        <div class="tab-pane" id="account">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-10 col-sm-offset-1">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">Area, Colony, Street,
                                                                Sector</label>
                                                            <input name="lastname" type="text"
                                                                class="form-control" />
                                                        </div>
                                    ...
                                    <div class="tab-pane" id="address">
                                        <div class="row" style="margin-top: 20px;">
                                            ...
                                            <div class="col-sm-6 col-md-6  col-lg-6"
                                                ...
                                                <img src="{{ asset('uploads/previewimages/' . $order->image) }}"
                                                    alt="Product-img" width="200px" height="200px"
                                                    style="object-fit: cover; padding-top: 10px; margin-left: 0px;">

                                                <div>
                                                    <h4 style="font-weight: bold;">{{ $order->name }}</h4>
                                                    <div
                                                        style="display: flex;justify-content: space-between;align-items: center;margin-top: 10px; font-weight: bold;">
                                                        <span>Sub Total</span>
                                                    ...
                                                    <p style="color: rgb(168, 166, 166);font-weight: bold;">(Free
                                                        delivery only for premium Users)</p>
                                                    <div
                                                        style="display: flex;justify-content: space-between;align-items: center;margin-top: 10px; font-weight: bold; border-top: 1px solid rgb(180, 178, 178);padding-top: 10px;">
                                                        <span>Total</span>
                                                        <span> ₹ {{ $order->price }}</span>
                                                    </div>
                                                </div>
							...
							<div style="display: flex; flex-direction: row;"  class="qrbox">
									...
									<div style="display: flex;  justify-content: space-between; margin-top: 10px;">
										...
										<span style="font-weight: bold; text-wrap: wrap;">Cash on Delivery</span>
                                            ...
                                            <button type="submit" class="btn "
                                                style="background-color: rgba(129, 130, 245, 0.938); margin-top: 3rem;">Proceed
                                                To Pay</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="wizard-footer">
                                    <div class="pull-right">
                                        <input type="button" class="btn btn-next btn-fill btn-wd" name="next"
                                            value="Next"
                                            style="background-color: rgba(129, 130, 245, 0.938); margin-bottom: 2rem;"
