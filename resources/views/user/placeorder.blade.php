              ...
              >
                    ...
                    <div class="tab-pane" id="address">
                      <div class="row" style="margin-top: 20px;">
                        ...
                        <div class="col-sm-6 col-md-6  col-lg-6" style="display: flex; justify-content: space-around; align-items: flex-start;">
                         <img src="https://5.imimg.com/data5/SELLER/Default/2023/10/353710768/JP/CW/LI/9627695/men-formal-shirts-500x500.jpg" alt="Product-img" width="200px" height="200px" style="object-fit: cover; padding-top: 10px; margin-left: 0px;">
						 <div >
                ...
                <div style="display: flex; flex-direction: column; width: 50%;">
                  ...
                  <img id="qr-code-image" src="" alt="QR Code">
							...
							<button class="btn " style="background-color: rgba(129, 130, 245, 0.938); margin-top: 3rem;">Pay now</button>
						  </div>
                      </div>
                    </div>
                  </div>
