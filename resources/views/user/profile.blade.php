                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" value="{{ @$userprofile->name ? $userprofile->name : '' }}" name="username">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="example-text-input" class="text-sm text-secondary">Email address</label>
                        <input class="form-control" type="email" value="{{@$userprofile->email ? $userprofile->email : ''}}" name="email ">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="example-text-input" class="text-sm text-secondary">First name</label>
                        <input class="form-control" type="text" value="{{@$userprofile->firstname ? $userprofile->firstname : ''}}" name="firstname">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="example-text-input" class="text-sm text-secondary">Last name</label>
                        <input class="form-control" type="text" value="{{@$userprofile->lastname ? $userprofile->lastname: '' }}" name="lastname">
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="{{@$userprofile->city ? $userprofile->city: ''}}" name="city">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="text-sm text-secondary">State</label>
                    <input class="form-control" type="text" value="{{@$userprofile->state ? $userprofile->state: ''}}" name="state">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="text-sm text-secondary">Country</label>
                    <input class="form-control" type="text" value="{{@$userprofile->country? $userprofile->country : ''}}" name="country">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="{{@$userprofile->pin_code ? $userprofile->pin_code : ''}}" name="postalcode">
                  </div>
                </div>
              </div>
              <hr class="horizontal dark">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="{{@$userprofile->company_name? $userprofile->company_name: '' }}" name="company">
                  </div>
                </div>
              </div>
                </div>
