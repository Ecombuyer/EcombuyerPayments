                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-actions">
                      <button class="btn btn-primary px-5" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                  ...
                  <div class="collapse card-body" id="collapseExample">
                    <div class="">
                      <form class="row g-3">
                        ...
                        <div class="col-md-4">
                          <label for="payment id" class="form-label" >Payment ID</label>
                        ...
                        <div class="col-12">
                          <button type="submit" class="btn btn-primary float-end px-5">Submit</button>
